...
const FormularioProyecto = () => {
  ...
  return (
    ...
    >
        ...
        <input type="submit" value={id ? 'Actualizar Proyecto' : 'Crear Proyecto'} className="bg-sky-600 p-3 uppercase font-bold text-white w-full cursor-pointer hover:bg-sky-700 transition-colors"/>
    </form>
  )
}
