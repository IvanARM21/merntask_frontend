...
const Tarea = ({tarea}) => {
    ...
    const { handleModalEditarTarea, handleModalEliminarTarea, handleReset, completarTarea } = useProyectos();
  ...
  return (
    <div className="border-b p-5 flex justify-between items-center">
        <div className="flex flex-col items-start">
            ...
            <p className="mb-1 text-xl text-gray-700">Prioridad: {prioridad}</p>
